...
<head>
    ...
    <title>Admin Desa PDI</title>
    <!-- Bootstrap Core CSS -->
    <link href="{{ asset('css/lib/bootstrap/bootstrap.min.css') }}" rel="stylesheet">
    <!-- Custom CSS -->

    <link href="{{ asset('css/icons/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('css/icons/simple-line-icons/css/simple-line-icons.css') }}" rel="stylesheet">
    <link href="{{ asset('css/icons/weather-icons/css/weather-icons.min.css') }}" rel="stylesheet">
    <link href="{{ asset('css/icons/linea-icons/linea.css') }}" rel="stylesheet">
    <link href="{{ asset('css/icons/themify-icons/themify-icons.css') }}" rel="stylesheet">
    <link href="{{ asset('css/icons/flag-icon-css/flag-icon.min.css') }}" rel="stylesheet">
                                ...
                                <div class="testimonial-widget-one owl-carousel owl-theme">
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="{{ asset('img/avatar/2.jpg') }}" alt="" />
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="{{ asset('img/avatar/3.jpg') }}" alt="" />
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="{{ asset('img/avatar/1.jpg') }}" alt="" />
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="{{ asset('img/avatar/4.jpg') }}" alt="" />
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="{{ asset('img/avatar/5.jpg') }}" alt="" />
                                            <div class="testimonial-author">TYRION LANNISTER</div>
                                            <div class="testimonial-author-position">Founder-Ceo. Dell Corp</div>
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="{{ asset('img/avatar/6.jpg') }}" alt="" />
                                            <div class="testimonial-author">TYRION LANNISTER</div>
                                            <div class="testimonial-author-position">Founder-Ceo. Dell Corp</div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href=""><img src="{{ asset('img/avatar/4.jpg') }}" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>John Abraham</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href=""><img src="{{ asset('img/avatar/2.jpg') }}" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>John Abraham</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href=""><img src="{{ asset('img/avatar/3.jpg') }}" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>John Abraham</td>
								...
								<div class="recent-comment">
									<div class="media">
										<div class="media-left">
											<a href="#"><img alt="..." src="{{ asset('img/avatar/1.jpg') }}" class="media-object"></a>
										</div>
