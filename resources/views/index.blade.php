    ...
    <div class="container">
      <div class="row">
        <div class="intro-text">
          <h1>Desa Pondok Indah</h1>
          <hr>
          <p>Rukun • Kompak • Kerja Sama yang Baik • Mujhid/Muhzit</p>
...
<div id="about">
  <div class="container">
    <div class="section-title text-center center">
      <h2>About Desa Pondok Indah</h2>
      <hr>
    </div>
    <div class="row">
      <div class="col-md-12 text-center"><img src="{{ asset('img/about.jpg') }}" class="img-responsive"></div>
      <div class="col-md-8 col-md-offset-2">
        <div class="about-text">
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo nec ornare diam. Sed commodo nibh ante facilisis bibendum dolor feugiat at. Duis sed dapibus leo nec ornare diam commodo nibh.</p>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo nec ornare diam. Sed commodo nibh ante facilisis bibendum dolor feugiat at. Duis sed dapibus leo nec ornare.</p>
          <a href="#portfolio" class="btn btn-default btn-lg page-scroll">Gallery</a> </div>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="portfolio-items">
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 photography">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="{{ asset('img/portfolio/10-large.jpg') }}" title="Project Title" data-lightbox-gallery="gallery1">
              <div class="hover-text">
                <h4>Project Title</h4>
              </div>
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 photography">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="{{ asset('img/portfolio/11-large.jpg') }}" title="Project Title" data-lightbox-gallery="gallery1">
              <div class="hover-text">
                <h4>Project Title</h4>
              </div>
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 graphic">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="{{ asset('img/portfolio/12-large.jpg') }}" title="Project Title" data-lightbox-gallery="gallery1">
              <div class="hover-text">
                <h4>Project Title</h4>
              </div>
